...
// import type { IStoryEvent } from '../../../../story/interface';
...
//       h.addEventListener('pointerdown', (e: IStoryEvent) => {
//         this._onResizeStart(h, e);
//       });

//       h.addEventListener('pointerover', (e: IStoryEvent) => {
//         this._showHandleGraphic();
//       });
//       h.addEventListener('pointerout', (e: IStoryEvent) => {
...
//   private _onResizeStart(h: IGroup, e: IStoryEvent) {
//     // 当前选择数据已不存在
//     if (!this._actionInfo) {
//       return;
//     }
...
//   private _handleMove = (e: IStoryEvent) => {
//     const layerPos = transformPointWithMatrix(this._graphicGroup.globalTransMatrix, e.canvas);
...
//   private _handleUp = (e: IStoryEvent) => {
//     this._barBorder.setAttributes({ visible: false });
