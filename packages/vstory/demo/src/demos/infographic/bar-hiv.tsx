...
export const BarHIV = () => {
  ...
  useEffect(() => {
    ...
    const bg = (index: number, fill: string, y: number, height: number, _graphic: any = {}) => {
      return {
        id: 'bg' + index,
        type: 'Rect',
        zIndex: 0,
        position: { x: 0, y, width: 1056, height },
        options: { graphic: { fill, fillOpacity: 1, ..._graphic } }
      };
    };
    ...
    const dsl = {
      ...
      characters: [
        ...
        bg(1, '#222A5A', 350, 464),
        {
          ...
          type: 'Rect',
          zIndex: 1,
          position: { x: 346, y: 37, width: 674, height: 581 },
          options: { graphic: { fill: 'white', fillOpacity: 1, cornerRadius: 10 } }
        },
        {
          id: 'chart',
          type: 'VChart',
              ...
              series: [
                {
                  ...
                  label: {
                    ...
                    style: { stroke: false, fill: 'black', fontWeight: 'bold', fontSize: 18 }
                  }
                }
              ],
              data: [
              ...
              axes: [
                {
                  ...
                  domainLine: {
                    visible: true,
                    style: { strokeOpacity: 1, stroke: 'black' }
                  }
                },
                {
                  label: {
        ...
        },
        {
          ...
          type: 'Text',
          zIndex: 0,
          position: { x: 69, y: 83, width: 280, height: 300 },
          options: {
            graphic: {
              text: [
                'HIV Treatment',
        ...
        },
        {
          ...
          type: 'Text',
          zIndex: 0,
          position: { x: 69, y: 383, width: 280, height: 300 },
          options: {
            graphic: {
              text: [
        ...
        },
        {
          ...
          type: 'Text',
          zIndex: 2,
          position: { x: 464, y: 86, width: 800, height: 300 },
          options: {
            graphic: {
        ...
        },
        {
          ...
          type: 'Text',
          zIndex: 2,
          position: { x: 704, y: 140, width: 800, height: 300 },
          options: {
            graphic: {
              text: [
        ...
        },
        {
          ...
          type: 'Text',
          zIndex: 2,
          position: { x: 606, y: 549, width: 800, height: 300 },
          options: {
            graphic: {
        ...
        },
        {
          ...
          type: 'Text',
          zIndex: 2,
          position: { x: 808, y: 550, width: 800, height: 300 },
          options: {
            graphic: {
        ...
        },
        {
          ...
          type: 'Line',
          zIndex: 1,
          position: { x: 36, y: 656, width: 984, height: 2 },
          options: {
            graphic: {
              stroke: 'white',
              points: [
        ...
        },
        {
          ...
          options: {
            graphic: {
              fill: 'white',
              symbolType: `<svg t="1733974707467" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1748" xmlns:xlink="http://www.w3.org/1999/xlink" width="200" height="200"><path d="M965.7344 2.7648c14.848 0 28.2624 5.5296 40.2432 16.6912C1017.9584 30.5152 1024 43.52 1024 58.2656l0 910.2336c0 14.848-6.0416 27.7504-18.0224 38.8096C993.8944 1018.4704 980.48 1024 965.7344 1024L704.9216 1024 704.9216 629.9648l133.2224 0 19.456-155.4432-152.576 0L705.024 373.0432c0-50.688 25.9072-76.0832 77.7216-76.0832l80.4864 0L863.232 163.5328c-27.7504-5.4272-67.4816-8.192-119.296-8.192-59.1872 0-106.8032 18.0224-142.9504 54.0672C564.736 245.5552 546.7136 296.0384 546.7136 360.7552l0 113.7664L413.4912 474.5216l0 155.4432 133.2224 0L546.7136 1024 55.5008 1024c-14.848 0-27.7504-5.5296-38.8096-16.6912C5.5296 996.2496 0 983.3472 0 968.4992L0 58.2656C0 43.52 5.5296 30.5152 16.6912 19.456c11.0592-11.0592 24.064-16.6912 38.8096-16.6912L965.7344 2.7648z" fill="#ffffff" p-id="1749"></path></svg>`
            }
          }
        },
        {
        ...
        },
        {
          ...
          type: 'Text',
          zIndex: 2,
          position: { x: 135, y: 728, width: 800, height: 300 },
          options: {
            graphic: {
        ...
        },
        {
          ...
          type: 'Text',
          zIndex: 2,
          position: { x: 430, y: 690, width: 800, height: 300 },
          options: {
            graphic: {
        ...
        },
        {
          ...
          type: 'Text',
          zIndex: 2,
          position: { x: 430, y: 728, width: 800, height: 300 },
          options: {
            graphic: {
              text: [
    ...
    dsl.acts[0].scenes[0].actions[0].characterId = dsl.characters.map(c => c.id);
