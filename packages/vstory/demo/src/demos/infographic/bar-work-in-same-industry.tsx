...
registerAll();
export const BarWorkingInSameIndustry = () => {
  const id = 'BarWorkingInSameIndustry';
  useEffect(() => {
      ...
      characters: [
        {
          ...
          type: 'Rect',
          zIndex: 0,
          position: { x: 0, y: 0, width: 816, height: 816 },
          options: { graphic: { fill: '#F6F6F6', fillOpacity: 1 } }
        },
        {
          id: 'chart',
          type: 'VChart',
        ...
        },
        {
          ...
          options: {
            graphic: {
              ...
              stroke: 'black',
              lineWidth: 2,
              symbolType: `M1006.34 512L512 820.962 17.66 512 512 203.038 1006.34 512z` // M512 703.03799999L817.66 512 512 320.963 206.34 512 512 703.03799999z
            }
          }
        },
        {
          ...
          type: 'Text',
          zIndex: 0,
          position: { x: 408, y: 35, width: 816, height: 100 },
          options: {
            graphic: {
              textConfig: [{ text: 'Staying in the' }, { text: '\n' }, { text: 'Same Line of Work' }],
              // text: ['Staying in the', 'Same Line of Work'],
              textAlign: 'center',
              textBaseline: 'top',
              fontWeight: 'bold',
              fontSize: 40,
        ...
        },
        {
          ...
          type: 'Text',
          zIndex: 0,
          position: { x: 408, y: 223, width: 816, height: 100 },
          options: {
            graphic: {
              textConfig: [
                {
        ...
        },
        {
          ...
          type: 'Line',
          zIndex: 1,
          position: { x: 58, y: 174, width: 300, height: 4 },
          options: {
            graphic: {
              stroke: 'black',
              lineWidth: 4,
        ...
        },
        {
          ...
          type: 'Line',
          zIndex: 1,
          position: { x: 458, y: 174, width: 300, height: 4 },
          options: {
            graphic: {
              stroke: 'black',
              lineWidth: 4,
