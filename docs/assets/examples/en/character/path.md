...
`Path` is a basic Character built on SVG path data. It is suitable for irregular contours, icon outlines, and other custom vector shapes. Set `type: 'Path'` to use it as a Character.
