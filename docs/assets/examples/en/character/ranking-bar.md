...
Dynamic bar charts are interactive and visually striking data visualization tools. Unlike traditional static bar charts, dynamic bar charts display data changes through animation, making comparisons between different categories more lively and interesting. Dynamic bar charts can not only effectively convey the size and trend of data, but also attract the audience's attention, enhancing the effect of information transmission.
Set `type: 'rankingBar'` to use this chart as a Character.
