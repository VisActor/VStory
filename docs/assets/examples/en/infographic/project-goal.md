...
category: examples
group: infographic
title: Gauge Infographic(Project Goal Progress)
keywords: templates, visualization, gauge, goal, progress
order: 1-0
cover: https://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/vstory-infographic/preview/project-goal.jpeg
---

# Gauge Infographic(Project Goal Progress)
